...
//  Holiday&Alarm
//
//  Created by Chaos Lin on 13-12-8.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    HANotificationListViewController* rootVC = [[HANotificationListViewController alloc]initWithNibName:@"HANotificationListViewController" bundle:nil];
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [[HASituationManager sharedInstance] save];
    [[HACalendarManager sharedInstance] save];
}
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [HADBAccessClass sharedInstance];
}
